...
namespace CSharpE.Transform.VisualStudio
{
    ...
    {
        private readonly Compilation oldCompilation;
        private readonly Compilation newCompilation;
        ...
        public CompilationDiff(Compilation oldCompilation, Compilation newCompilation)
        {
