...
\todo{explain why I'm not actually using closures: closure could include too many variables, is not explicit and depends on compiler implementation details}
