...
\item The system should allow extensions to report errors and warnings.

Many extensions are likely going to have ways of using their \ac{API} (generated or not) in ways that are suspicious or outright incorrect. The system should let extensions report these issues to the user.
